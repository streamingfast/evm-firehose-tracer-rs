...
impl Tracer {
                ...
                if let Some(balance) = &account.balance {
                    if !balance.is_zero() {
                        self.on_balance_change(
                            ...
                            U256::ZERO,
                            *balance,
                            crate::pb::sf::ethereum::r#type::v2::balance_change::Reason::GenesisBalance,
                        );
                    }
                }
    ...
    pub fn on_tx_start(
        ...
        use crate::pb::sf::ethereum::r#type::v2::transaction_trace::Type;
        ...
        let access_list = event
            .access_list
            .iter()
            .map(|tuple| crate::pb::sf::ethereum::r#type::v2::AccessTuple {
        ...
        let set_code_authorizations = event
            ...
            .map(|auth| {
                ...
                crate::pb::sf::ethereum::r#type::v2::SetCodeAuthorization {
    ...
    fn complete_transaction(
        ...
        if let Some(receipt) = receipt {
            ...
            if receipt.status == 1 {
                trx.status =
                    crate::pb::sf::ethereum::r#type::v2::TransactionTraceStatus::Succeeded as i32;
            } else {
                trx.status =
                    crate::pb::sf::ethereum::r#type::v2::TransactionTraceStatus::Failed as i32;
            }
        }
    ...
    fn assign_ordinal_and_index_to_receipt_logs(trx: &mut TransactionTrace) {
        ...
        let mut call_logs: Vec<&crate::pb::sf::ethereum::r#type::v2::Log> = Vec::new();
    ...
    fn new_receipt_from_data(
        ...
        receipt: &ReceiptData,
        tx_type: i32,
    ) -> crate::pb::sf::ethereum::r#type::v2::TransactionReceipt {
    ...
    pub fn on_balance_change(
        ...
        old_balance: U256,
        new_balance: U256,
        reason: crate::pb::sf::ethereum::r#type::v2::balance_change::Reason,
    ) {
        firehose_trace!(
        ...
        if reason == crate::pb::sf::ethereum::r#type::v2::balance_change::Reason::Unknown {
            return;
        }
        ...
        let change = crate::pb::sf::ethereum::r#type::v2::BalanceChange {
    ...
    pub fn on_nonce_change(&mut self, addr: Address, old_nonce: u64, new_nonce: u64) {
        ...
        let change = crate::pb::sf::ethereum::r#type::v2::NonceChange {
            address: addr.0.to_vec(),
            old_value: old_nonce,
            new_value: new_nonce,
            ordinal: self.block_ordinal.next(),
    ...
    pub fn on_code_change(
        ...
        let change = crate::pb::sf::ethereum::r#type::v2::CodeChange {
            address: addr.0.to_vec(),
    ...
    pub fn on_storage_change(
        ...
        let change = crate::pb::sf::ethereum::r#type::v2::StorageChange {
            address: addr.0.to_vec(),
            key: slot.0.to_vec(),
    ...
    ) -> crate::pb::sf::ethereum::r#type::v2::BlockHeader {
        crate::pb::sf::ethereum::r#type::v2::BlockHeader {
            ...
            tx_dependency: block.tx_dependency.as_ref().map(|deps| {
                crate::pb::sf::ethereum::r#type::v2::Uint64NestedArray {
                    val: deps
                        .iter()
                        .map(|inner| crate::pb::sf::ethereum::r#type::v2::Uint64Array {
                            val: inner.clone(),
                        })
                        .collect(),
                }
